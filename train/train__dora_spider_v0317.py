# train_dora_spider0317.py
# 使用 DoRA (Weight-Decomposed LoRA) 微調 Llama-3.1-8B-Instruct
# 訓練資料: data/wp_m09/train_spider_WP_M09.json  (872 原始 + 103 修正樣本 = 975 筆)
#
# 執行方式:
#   python train_dora_spider0317.py
#
# 輸出:
#   outputs/models/wp_m09_dora_0317_spider/final_model/
...
def save_model(trainer, tokenizer, train_samples: int):
    ...
    info = {
        ...
        "train_script":    f"train_dora_spider{DATE_STR}.py",
...
def main():
    ...
    print(f"腳本: train_dora_spider{DATE_STR}.py")
    print(f"資料: 972原始+103修正 = 975 筆")
    print("=" * 60)
    ...
    print(f"   評估指令: python evaluate_em_ex.py --model {FINAL_MODEL} --gold data/wp_m09/test_spider_WP_M09_v2.json --output outputs/evaluation_0317_v1.json")
