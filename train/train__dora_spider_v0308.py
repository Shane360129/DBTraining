...
def save_model(trainer, tokenizer):
    ...
    info = {
        ...
        "train_script":    "train_dora_spider0308.py",
...
def main():
    ...
    print(f"腳本: train_dora_spider0308.py")
    print("=" * 60)
