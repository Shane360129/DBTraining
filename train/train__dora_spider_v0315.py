# train_dora_spider0315.py
# 使用 DoRA (Weight-Decomposed LoRA) 微調 Llama-3.1-8B-Instruct
# 訓練資料: data/wp_m09/train_spider_WP_M09.json  (Spider 1 格式, 0315版, 去除方括號)
#
# 執行方式:
#   python train_dora_spider0315.py
#
# 輸出:
#   outputs/models/wp_m09_dora_0315_spider/final_model/
...
def extract_table_from_sql(sql: str) -> str:
    """從 SQL 中提取第一個 WP_M09.dbo.XXX 或 [WP_M09].[dbo].[XXX] 裡的 view/table 名稱。"""
    # 先嘗試無括號格式
...
def save_model(trainer, tokenizer):
    ...
    info = {
        ...
        "train_script":    "train_dora_spider0315.py",
...
def main():
    ...
    print(f"腳本: train_dora_spider0315.py")
    print("=" * 60)
