# train_dora_spider0314.py
# 使用 DoRA (Weight-Decomposed LoRA) 微調 Llama-3.1-8B-Instruct
# 訓練資料: data/wp_m09/train_spider_WP_M09.json  (Spider 1 格式, 0314版, 去除方括號)
#
# 執行方式:
#   python train_dora_spider0314.py
#
# 輸出:
#   outputs/models/wp_m09_dora_0314_spider/final_model/
...
def save_model(trainer, tokenizer):
    ...
    info = {
        ...
        "train_script":    "train_dora_spider0314.py",
...
def main():
    ...
    print(f"腳本: train_dora_spider0314.py")
    print("=" * 60)
